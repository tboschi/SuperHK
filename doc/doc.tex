...
\end{itemize}
\footnotetext{Not fully tested. Please email any bug to \href{mailto:boschi.tommaso@gmail.com}{boschi.tommaso@gmail.com}.}
...
which describes a grid space of \np{195871} points.
...
\begin{tabular}{c@{\hspace{3em}}c@{\hspace{3em}}c}
	...
	\begin{tabular}[t]{lc}
		...
		Parameter &	$\sigma$ (\%)	 \\
		\midrule
		2p-2h normalization for \tapi{16}O		& 0.673 \\
		...
		CC-coherent for \tapi{16}O normalization	& 0.148	\\
		NC-coherent normalization			& 0.235	\\
		NC-other normalization				& 0.300	\\
		CC-$\nu_e$ normalization			& 0.028	\\
		NC-1$\gamma$ normalization			& 1.000	\\
		CC-$\nu_e$ normalization			& 0.028	\\
		...
		2p-2h \tapi{12}C to \tapi{16}O normalization	& 0.130	\\

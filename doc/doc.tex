...
\end{itemize}
\footnotetezt{Not fully tested. Please email any bug to \mailto
...
The executables could be highly optimised for the native architecture of the machine where they are running over.

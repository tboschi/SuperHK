...
int main(int argc, char** argv)
{
	...
	//ideally this should be done for each and individually, but....
	double xMin, xMax;
	int nBin = nuE0_nuE0_m0->BinRangeX(xMin, xMax);

	TF1* f1 = new TF1("const", "[0]", xMin, xMax);
	f1->SetParameter(0, 1.0);

	//oscillation to apply to 2Dhist
	TH1D* flx_nuE0_nuE0_m0 = new TH1D("flx_nuE0_nuE0_m0", "flx_nuE0_nuE0_m0", nBin, xMin, xMax);
	TH1D* flx_nuM0_nuM0_m0 = new TH1D("flx_nuM0_nuM0_m0", "flx_nuM0_nuM0_m0", nBin, xMin, xMax);
	TH1D* flx_nuM0_nuE0_m0 = new TH1D("flx_nuM0_nuE0_m0", "flx_nuM0_nuE0_m0", nBin, xMin, xMax);
	TH1D* flx_nuEB_nuEB_m0 = new TH1D("flx_nuEB_nuEB_m0", "flx_nuEB_nuEB_m0", nBin, xMin, xMax);
	TH1D* flx_nuMB_nuMB_m0 = new TH1D("flx_nuMB_nuMB_m0", "flx_nuMB_nuMB_m0", nBin, xMin, xMax);
	TH1D* flx_nuMB_nuEB_m0 = new TH1D("flx_nuMB_nuEB_m0", "flx_nuMB_nuEB_m0", nBin, xMin, xMax);

	//constant histograms at 1
	flx_nuE0_nuE0_m0->Add(f1);
        flx_nuM0_nuM0_m0->Add(f1);
        flx_nuM0_nuE0_m0->Add(f1);
        flx_nuEB_nuEB_m0->Add(f1);
        flx_nuMB_nuMB_m0->Add(f1);
        flx_nuMB_nuEB_m0->Add(f1);
	...
	TH1D* flx_nuE0_nuE0_mB = new TH1D("flx_nuE0_nuE0_mB", "flx_nuE0_nuE0_mB", nBin, xMin, xMax);
	TH1D* flx_nuM0_nuM0_mB = new TH1D("flx_nuM0_nuM0_mB", "flx_nuM0_nuM0_mB", nBin, xMin, xMax);
	TH1D* flx_nuM0_nuE0_mB = new TH1D("flx_nuM0_nuE0_mB", "flx_nuM0_nuE0_mB", nBin, xMin, xMax);
	TH1D* flx_nuEB_nuEB_mB = new TH1D("flx_nuEB_nuEB_mB", "flx_nuEB_nuEB_mB", nBin, xMin, xMax);
	TH1D* flx_nuMB_nuMB_mB = new TH1D("flx_nuMB_nuMB_mB", "flx_nuMB_nuMB_mB", nBin, xMin, xMax);
	TH1D* flx_nuMB_nuEB_mB = new TH1D("flx_nuMB_nuEB_mB", "flx_nuMB_nuEB_mB", nBin, xMin, xMax);

	//constant histograms at 1
	flx_nuE0_nuE0_mB->Add(f1);
        flx_nuM0_nuM0_mB->Add(f1);
        flx_nuM0_nuE0_mB->Add(f1);
        flx_nuEB_nuEB_mB->Add(f1);
        flx_nuMB_nuMB_mB->Add(f1);
        flx_nuMB_nuEB_mB->Add(f1);

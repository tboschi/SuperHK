...
BINNAME=GlobalSpaghettiSensitivityStatOnly
...
OUTDIR=$5
CARDNAME=${CARD##*/}
#OUTDIR=/home/tboschi/data/asimov.large/spag_stat_t$TPOINT
#CARD=scan.asimov
#OUTDIR=/home/tboschi/data/hkdr.large/spag_stat_t$TPOINT
#CARD=scan.hkdr
#CARD2=$CARD
